...
\end{figure}
El módulo \textit{auxiliary} contiene  herramientas externas como pueden ser escáners de vulnerabilidades, sniffers, etc. En este caso usaremos \textit{synflood}. Con \textit{set RHOST 192.168.1.236}, indicamos la ip de nuestra víctima. Por último, ``explotamos'' el ataque para que se haga efectivo.\\
